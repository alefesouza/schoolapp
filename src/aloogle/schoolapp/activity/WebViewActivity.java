		...
		if (ScheduleCalendarOrAdd == 0) {
			...
			try {
				...
				String about = "" +
					...
					"<p style=\"text-align: justify;\">Caso voc&ecirc; seja desenvolvedor e queira fazer uma vers&atilde;o modificada do aplicativo contendo an&uacute;ncios ou qualquer outra forma de lucro, por favor pe&ccedil;a minha permiss&atilde;o entrando em contato comigo.";
		...
		case R.id.menu_refresh:
			if (cm != null && cm.getActiveNetworkInfo() != null && cm.getActiveNetworkInfo().isConnected()) {
				if (Build.VERSION.SDK_INT >= 8) {
					...
					boolean refreshwarning = preferences.getBoolean("refreshWarning", true);
					if (refreshwarning) {
						final AlertDialog dialogrefresh = new AlertDialog.Builder(this)
						...
						dialogrefresh.setOnShowListener(new
							DialogInterface.OnShowListener() {
							@Override
							public void onShow(DialogInterface dialog) {
								Button b = dialogrefresh.getButton(AlertDialog.BUTTON_POSITIVE);
								b.setOnClickListener(new
									...
									public void onClick(View view) {
										...
										editor.putBoolean("refreshWarning", false);
										editor.commit();
