...
public class ReadingFragment2 extends Fragment implements AbsListView.OnScrollListener, SwipeRefreshLayout.OnRefreshListener {
	Activity activity;
	View view;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		if (!getArguments().getString("categoria").equals("")) {
			url = "http://apps.aloogle.net/schoolapp/rebua/json/livros.php?categoria=" + getArguments().getString("categoria") + "&alfabetica=false";
		} else {
			url = "http://apps.aloogle.net/schoolapp/rebua/json/busca.php?q=" + getArguments().getString("query") + "&alfabetica=false";
		}
		...
		protected void onPostExecute(JSONObject json) {
			...
			try {
				try {
					...
					list.setOnScrollListener(ReadingFragment2.this);
					list.setSelection(more);

					page += 1;
					if (!getArguments().getString("categoria").equals("")) {
						url = "http://apps.aloogle.net/schoolapp/rebua/json/livros.php?categoria=" + getArguments().getString("categoria") + "&alfabetica=false&page=" + String.valueOf(page);
					}
