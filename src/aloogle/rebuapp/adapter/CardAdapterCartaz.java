...
public class CardAdapterCartaz extends BaseAdapter {
	...
	public CardAdapterCartaz(Context context, ArrayList <String> title, ArrayList <String> settings, ArrayList <String> url) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			...
			convertView = mInflater.inflate(
					R.layout.header2, null);
		}

		CustomTextView titulo = (CustomTextView)convertView.findViewById(R.id.text);
		...
		relative.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				intent.putExtra("settings", settings.get(position).toString());
