...
public class WebViewActivity extends ActionBarActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			if (webViewValue == 0) {
				Other.SupportActionBarColor(this, getString(R.string.schedules));
				...
				Other.SupportActionBarColor(this, getString(R.string.calendar));
				web.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
				...
				Other.SupportActionBarColor(this, getString(R.string.panel));
				...
				Other.SupportActionBarColor(this, getString(R.string.announcements));
				web.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
				...
				Other.SupportActionBarColor(this, getString(R.string.annotations));
				web.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
				web.loadUrl("file:///android_asset/anotacoes.html");
			} else if (webViewValue == 5) {
				Other.SupportActionBarColor(this, getString(R.string.about));
				String about = "" +
				...
				Other.SupportActionBarColor(this, getString(R.string.readingroom));
				...
				Other.SupportActionBarColor(this, getString(R.string.messages));
				web.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
				...
				Other.SupportActionBarColor(this, getString(R.string.announcements) + " - Clubes");
				web.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
				...
				Other.SupportActionBarColor(this, getString(R.string.clubeaddnew));
				web.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
				...
				Other.SupportActionBarColor(this, getString(R.string.announcements) + " - Eletivas");
				web.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
